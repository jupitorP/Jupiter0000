...
return array(
    ...
    'import' => array(
        ...
        'application.extensions.LnwUpload',
        'application.extensions.galleria.*',
        'application.extensions.tslide.*'
    ),
    /* 'clientScript' => array(
      'class' => 'CClientScript',
      'scriptMap' => array(
    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                'tag/<TagName:[A-Za-z0-9ก-๙\s]+>' => 'tag/view',
        ...
        'db' => array(
            'class' => 'CDbConnection',
            'connectionString' => 'mysql:host=localhost;dbname=panyasys_yii', //override my_database for you actual db
            'username' => 'root',
            'password' => '',
            'charset' => 'utf8',
    ...
    'params' => array(
        ...
        'adminEmail' => 'tony_panya@hotmail.com',
    )
);
?>