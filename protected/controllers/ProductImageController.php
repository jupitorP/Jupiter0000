...
class ProductImageController extends Controller {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['ProductImage'])) {
            ...
            if ($model->save())
                $this->redirect(array('view', 'id' => $model->pdimg_id));
        }
    ...
    public function actionDelete($id) {
        $model = $this->loadModel($id);
        $model->delete();
        $imgProduct = $model->pdimg_name;
        //$bigImg= str_replace('/s/','/b/',$model->pdimg_name);
        @unlink('images/products/thumbs/' . $imgProduct);
        @unlink('images/products/larges/' . $imgProduct);
        @unlink('images/products/mediums/' . $imgProduct);
    }
